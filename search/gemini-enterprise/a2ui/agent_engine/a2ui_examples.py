...
[
  ...
  { "surfaceUpdate": {
    ...
    "components": [
      ...
      { "id": "card-layout", "component": { "Row": { "children": { "explicitList": ["template-image", "card-details", "view-button"] }, "alignment": "center", "distribution": "spaceBetween" } } },
      { "id": "template-image", "component": { "Image": { "url": { "path": "imageUrl" }, "fit": "cover", "usageHint": "avatar" } } },
    ...
    "contents": [
      { "key": "contacts", "valueMap": [
        { "key": "contact1", "valueMap": [
          ...
          { "key": "imageUrl", "valueString": "https://lh3.googleusercontent.com/a/default-user=s80-cc" },
  ...
  },
  {
    "dataModelUpdate": {
      ...
      "contents": [
        ...
        {
          "key": "team",
          "valueString": "Cloud AI"
        },
        {
          "key": "location",
          "valueString": "Sunnyvale, CA"
        },
        {
          "key": "email",
          "valueString": "alex.jordan@google.com"
        },
        {
          "key": "mobile",
        ...
        {
          "key": "calendar",
          "valueString": "Available until 5:00 PM PST"
        },
        {
          "key": "imageUrl",
          "valueString": "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop"
        }
      ]
    }
  }
