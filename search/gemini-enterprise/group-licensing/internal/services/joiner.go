// Package services contains the core business logic for the Gemini Box Office
// batch workflows. Each service is intentionally synchronous and free of
// concurrency primitives so that rate-limiting and worker-pool decorators can
// be layered on top without coupling them to domain logic.
package services
