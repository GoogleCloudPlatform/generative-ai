...
| `DEMO_DISPLAY_NAME` | `Demo Agent` | setup | Gemini Enterprise agent display name. |
| `DEMO_DESCRIPTION` | `Operational AI Agent` | setup | Gemini Enterprise agent description. |
