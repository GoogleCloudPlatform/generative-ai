...
from google.cloud.aiplatform_v1 import FindNeighborsRequest, IndexDatapoint, MatchServiceClient, FindNeighborsResponse
...
class VertexAIService():
    ...
    def vector_search_query(
        ...
        return match_service_client.find_neighbors(
        ...
        ).nearest_neighbors[0].neighbors

    def get_index_name(self, index_endpoint: MatchingEngineIndexEndpoint) -> str:
        return MatchingEngineIndex(index_endpoint.deployed_indexes[0].index).display_name
