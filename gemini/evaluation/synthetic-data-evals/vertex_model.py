...
class VertexAIServerModel(Model):
    ...
    def __init__(
        self, model_id: str = None, project_id: str = None, location: str = None, 
        endpoint_id: str = None, use_deepseek: bool = False, **kwargs
    ):
    ...
    def _response_to_chat_message(self, response) -> ChatMessage:
        ...
        try:
            ...
            message_dict = message_data.model_dump(include={"role", "content", "tool_calls"})
        except Exception as e:
...
class WeaveVertexAIServerModel(weave.Model):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            endpoint_id=(endpoint_id or os.getenv("DEEPSEEK_ENDPOINT_ID") if use_deepseek 
