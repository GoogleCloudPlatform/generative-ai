...
export default function EditCalendar() {
  ...
  const { status, setStatus, reset, updateEvent } = Status();
  ...
  return (
    <Dialog fullWidth={true} maxWidth="md" open={status.active && status.processed}>
      <DialogTitle>
            ...
            <Grid container spacing={1}>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DateTimePicker
                  ...
                  onChange={(e) => updateEvent("start", e?.toDate() || new Date())}
                  sx={{ width: "100%", mt: 1 }}
                  disabled={disabled}
                />
              </Grid>
              <Grid size={{ xs: 12, sm: 6 }}>
                <DateTimePicker
                  ...
                  onChange={(e) => updateEvent("end", e?.toDate() || new Date())}
                  sx={{ width: "100%", mt: 1 }}
                  disabled={disabled}
                />
              </Grid>
