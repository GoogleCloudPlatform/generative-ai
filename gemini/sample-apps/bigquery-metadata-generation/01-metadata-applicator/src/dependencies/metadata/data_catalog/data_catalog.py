...
from google.cloud import bigquery, datacatalog_v1, datacatalog_v1beta1
...
class DataCatalog:
    ...
    def create_table_overview(
        ...
        request = datacatalog_v1.ModifyEntryOverviewRequest(
            ...
            entry_overview=datacatalog_v1.EntryOverview(overview=overview),
        )
    ...
    def get_all_taxonomies(self):
        return self._client_policy.list_taxonomies(
            parent=f"projects/{self.project_id}/locations/{self.taxonomy_location}"
        )
