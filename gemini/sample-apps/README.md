...
This directory contains sample applications that demonstrate how to use the Gemini API in Vertex AI Agent Platform.
...
- [Finance Advisor with Spanner](finance-advisor-spanner/): A demo application that showcases how to use Spanner and Vertex AI Agent Platform to build a financial advisor application.
...
- [GenWealth](genwealth/): A demo application for a fictional financial services company that showcases how to build trustworthy Gen AI features into existing applications using AlloyDB AI, Vertex AI Agent Platform, Cloud Run, and Cloud Functions.
...
- [LlamaIndex RAG](llamaindex-rag/): An advanced Retrieval-Augmented Generation (RAG) system using LlamaIndex and Google Cloud Vertex AI Agent Platform for rapid prototyping and experimentation.
- [Photo Discovery](photo-discovery/): A demo that integrates a Vertex AI Agent Platform Agent with a multi-platform Flutter app to identify landmarks and merchandise from photos.
