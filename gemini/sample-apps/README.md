...
This directory contains sample applications that demonstrate how to use the Gemini API on Gemini Enterprise Agent Platform.
...
- [Finance Advisor with Spanner](finance-advisor-spanner/): A demo application that showcases how to use Spanner and Gemini Enterprise Agent Platform to build a financial advisor application.
...
- [GenWealth](genwealth/): A demo application for a fictional financial services company that showcases how to build trustworthy Gen AI features into existing applications using AlloyDB AI, Gemini Enterprise Agent Platform, Cloud Run, and Cloud Functions.
...
- [LlamaIndex RAG](llamaindex-rag/): An advanced Retrieval-Augmented Generation (RAG) system using LlamaIndex and Gemini Enterprise Agent Platform for rapid prototyping and experimentation.
- [Photo Discovery](photo-discovery/): A demo that integrates a Gemini Enterprise Agent Platform agent with a multi-platform Flutter app to identify landmarks and merchandise from photos.
- [Prism](prism-science-explainer/): Ask a plain science question and a multi-agent system researches it with a parallel swarm grounded in Google Search, then writes an interactive instrument to explain it — a running simulation with controls you can drag, statically verified to actually animate. Runs end to end on Gemini 3.7 Flash.
