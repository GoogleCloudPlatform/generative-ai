...
class QARetriever(BaseRetriever):
    ...
    def _retrieve(self, query_bundle: QueryBundle) -> List[NodeWithScore]:
        ...
        for nodewscore in qa_nodes:
            ...
            source_doc_id = nodewscore.node.relationships[NodeRelationship.SOURCE].node_id
            og_docs.append(NodeWithScore(node=self._docstore.get_document(source_doc_id), score=nodewscore.score))
