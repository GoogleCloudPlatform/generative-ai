...
- **Flexible LLM Integration**: Supports multiple Gemini models (`gemini-3-flash-preview`, `gemini-3-flash-preview`) and Claude models (`claude-3.5-sonnet`) with configurable parameters.
