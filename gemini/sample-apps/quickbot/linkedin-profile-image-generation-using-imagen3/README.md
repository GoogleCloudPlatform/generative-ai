# Quickbot - LinkedIn Templates using Imagen3

Quickbot LinkedIn Templates is an innovative application built with Google Cloud's Imagen3 model on Vertex AI. It provides a user-friendly frontend interface and a robust backend API to generate engaging images for LinkedIn posts using customizable templates and text prompts.
