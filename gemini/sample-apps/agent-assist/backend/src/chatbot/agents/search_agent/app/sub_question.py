...
Your task is to simplify these complex queries into simple straightforward \
questions.
...
Ensure the questions you generate are clear and based only on existing \
information,
...
INPUT: Compare Arogyasanjeevani Life Insurance and HDFC Ergo Insurance for \
cataract coverage
OUTPUT: What are the cataract coverage details?
---------------------
INPUT: Which policy is recommended for a 40-year-old diabetic?
OUTPUT: Please provide all the inclusions for diabetes for the 40-year-old age\
 group.
---------------------
INPUT: Contrast Travel Insure and Allianz Global Assistance for lost baggage \
coverage
OUTPUT: What is the extent of lost baggage coverage?
---------------------
INPUT: Recommend the best policy for maternity benefits between Max Bupa \
Health Companion and ICICI Prudential Health Protector.
OUTPUT: Can you specify the maternity benefits?
---------------------
INPUT: Recommend the best policy for maternity benefits.
OUTPUT: Can you specify the maternity benefits?
---------------------
INPUT: Evaluate LIC Jeevan Anand and SBI Life Smart Money Back for critical \
illness coverage
...
---------------------
INPUT: Assess Bajaj Allianz Health Guard and Reliance HealthWise for \
