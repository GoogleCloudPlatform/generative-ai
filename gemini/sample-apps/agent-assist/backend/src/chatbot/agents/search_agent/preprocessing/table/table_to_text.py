...
from src.chatbot.agents.search_agent.preprocessing.table \
    .process_function import processTable
...
def process_pdf_tables(DOCUMENT_PATH: str, POLICY_NAME: str) -> None:
    ...
    Args:
        ...
        POLICY_NAME (str): The name of the policy to which the
        PDF document belongs.
