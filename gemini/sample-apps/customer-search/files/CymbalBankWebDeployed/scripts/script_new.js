'use strict';
import { auth, signIn, signUp, signOutUser, onAuthStateChanged } from './auth.js'
...
const authenticateTabsContainer = document.querySelector('.authenticate__tab-container');
const authenticateTabsContent = document.querySelectorAll('.authenticate__content');
...
const openModalCreateAccount = function (e) {
    ...
    const createAccountContent = document.querySelector('.authenticate__content--2');
    ...
    const activeContent = document.querySelector('.authenticate__content--active');
...
if (operationsTabsContainer != null) {
    operationsTabsContainer.addEventListener('click', function (e) {
        ...
        operationsTabsContent.forEach(t => t.classList.remove('operations__content--active'));
...
if (authenticateTabsContainer != null) {
    authenticateTabsContainer.addEventListener('click', function (e) {
        ...
        // Remove active classes
        authenticateTabs.forEach(t => t.classList.remove('authenticate__tab--active'));
        authenticateTabsContent.forEach(t => t.classList.remove('authenticate__content--active'));
