...
def hello_http(request):
        ...
        if tag == "rag":
            ...
            if "en" in source_language_code:
                ...
                response = translate_text(
                    rag_qa_chain_json["fulfillment_response"]["messages"][0][
                        "text"
                    ]["text"][0],
                    project_id,
                    "en-US",
            ...
            if "en" not in source_language_code:
                set_default_param_json["fulfillment_response"]["messages"][0][
                    "text"
                ]["text"][0] = translate_text(
                    set_default_param_json["fulfillment_response"]["messages"][
                        0
                    ]["text"]["text"][0],
                    project_id,
                    "en-US",
            ...
            res = requests.post(
                url, data=json.dumps(request_json), headers=headers
            )
            res_json = res.json()
            headers = {"Access-Control-Allow-Origin": "*"}

            if "en" not in source_language_code:
                res_json["fulfillment_response"]["messages"][0]["text"][
                    "text"
                ][0] = translate_text(
                    res_json["fulfillment_response"]["messages"][0]["text"][
                        "text"
            ...
            if "en" not in source_language_code:
                for i in range(
                    ...
                    res_json["fulfillment_response"]["messages"][i]["text"][
                        ...
                        res_json["fulfillment_response"]["messages"][i][
                            "text"
                        ]["text"][0],
                        project_id,
                        "en-US",
            ...
            if "en" not in source_language_code:
                ...
                for i in range(
                    len(
                        res_json["fulfillment_response"]["messages"][1][
                            "payload"
                        ]["richContent"][0][0]["text"]
                    )
                ):
            ...
            if "en" not in source_language_code:
                for i in range(
                    ...
                    if (
                        "text"
                        in res_json["fulfillment_response"]["messages"][i]
                    ):
                        res_json["fulfillment_response"]["messages"][i][
                            "text"
                        ]["text"][0] = translate_text(
    ...
    res = {
        "fulfillment_response": {
            "messages": [
                {"text": {"text": [response, json.dumps(reference_list)]}}
            ]
        }
    }
    # Set CORS headers for the main request
