...
def hello_http(request):
    ...
    response = model.generate_response(
        f"""You are a chatbot for bank application and you are required to briefly summarize
    the key insights of given numerical values as Investment Summary in small pointers.
