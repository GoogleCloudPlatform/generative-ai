...
class PlanningAgent(BaseModel):
    ...
    def _create_steps(self, validated_query: QueryValidation, enable_search: bool) -> List[PlanStep]:
          ...
          if enable_search:
              ...
              steps.append(
                  PlanStep(
                      ...
                      input_requirements=["QueryEntity result", "DataGatherAgent result", "search_depth"],
