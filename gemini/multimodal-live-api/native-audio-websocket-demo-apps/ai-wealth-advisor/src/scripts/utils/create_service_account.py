...
"""
A Python script to create a Google Cloud Platform (GCP) service account within a specified project.
...
def create_service_account(project_id: str, account_id: str, display_name: str) -> bool:
    """
    Creates a new service account in the specified GCP project if it doesn't exist.
...
#         description="Create a GCP Service Account and assign it specific IAM roles.",
