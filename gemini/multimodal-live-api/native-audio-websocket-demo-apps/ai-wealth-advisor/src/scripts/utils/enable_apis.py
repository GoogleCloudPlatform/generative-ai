...
def enable_apis(apis: List[str], project: Optional[str]) -> None:
    """
    Enables a list of APIs for the specified GCP project.
...
@app.command()
def main(
    project_id: str = typer.Option(default=None, help="ID of the GCP project (required, e.g., 'your-gcp-project-id')"),
