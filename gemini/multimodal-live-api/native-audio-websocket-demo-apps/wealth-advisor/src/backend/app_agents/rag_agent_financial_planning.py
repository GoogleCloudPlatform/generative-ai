...
rag_agent_financial_planning = Agent(
    ...
    instruction="Act as a financial knowledge assistant. Leverage the `search_financial_documents` tool to query the internal knowledge base regarding financial products, retirement strategies, and current rates (e.g., CDs). If the tool provides no data, clearly state that the information is absent from your knowledge base.",
