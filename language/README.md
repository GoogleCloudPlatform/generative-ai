...
│   ├── <a href="hello-world/intro_generative_ai_studio.md">intro_generative_ai_studio.md</a>
│   └── <a href="hello-world/intro_palm_api.ipynb">[Notebook] Getting Started with the Vertex AI PaLM API & Python SDK</a>
...
│   └── <a href="third-party/langchain">langchain/</a>
│       └── <a href="third-party/langchain/intro_langchain_palm_api.ipynb">[Notebook] Getting Started with LangChain 🦜️🔗 + Vertex AI PaLM API</a>
...
└── <a href="use-cases">use-cases/</a>
    ...
    │   ├── <a href="use-cases/document-qa/question_answering_large_documents.ipynb">[Notebook] Question Answering with Large Documents</a>
    │   └── <a href="use-cases/document-qa/question_answering_large_documents_langchain.ipynb">[Notebook] Question Answering with Large Documents using LangChain 🦜🔗</a>
