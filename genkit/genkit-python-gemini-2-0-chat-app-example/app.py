...
load_dotenv()  
# TODO: Get a Gemini API Key, and it to a .env file, and uncomment the below line
...
REGION = "us-west1"
PROJECT_NAME = "" # TO DO: Insert Project Name
...
# --- call_model function ---
async def call_model(user_prompt_str: str, sys_instructions_str: str) -> str:
    """
    Gets a response from the LLM using the configured Genkit ai object.
    """
    print(f"[call_model] Received prompt: \"{user_prompt_str}\"")
    ...
    try:
        ...
        print(f"[call_model] LLM Response: \"{response.text}\"")
...
if prompt := st.chat_input():
    ...
    with st.spinner("Thinking..."):
       ...
       model_response = asyncio.run(call_model(prompt, system_instructions))
