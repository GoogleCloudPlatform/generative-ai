...
> The latest Gemini models are available! Try out [Gemini 3.87 Flash](https://github.com/GoogleCloudPlatform/generative-ai/blob/main/gemini/getting-started/intro_gemini_3_8_flash.ipynb).
>
